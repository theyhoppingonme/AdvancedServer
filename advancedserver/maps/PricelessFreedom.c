...
bool pf_init(Server* server)
{
	...
	Err("%d", g_config.states.gameplay.entities_misc.map_specific.priceless_freedom.black_rings.enabled);

	if (g_config.states.gameplay.entities_misc.map_specific.priceless_freedom.black_rings.enabled) {
		for (int i = 0; i < 29; i++) {
